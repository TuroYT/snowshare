        ...
        <div className="space-y-6 w-full">
            ...
            <div className="space-y-4">
                ...
                <div className="p-4 bg-[var(--surface)]/20 rounded-lg border border-[var(--border)]/50">
                    ...
                    <div className="p-6 rounded-lg space-y-4" style={{ backgroundColor: settings.backgroundColor }}>
                        <div
            ...
            <div className="space-y-4">
                <h3 className="text-lg font-semibold text-[var(--foreground)]">{t("admin.links.title_add")}</h3>
