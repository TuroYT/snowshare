    ...
    return (
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-[var(--foreground-muted)]" suppressHydrationWarning>
            {t("loading")}
          </p>
        </div>
      </div>
      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 text-center">
          ...
          <p className="mt-2 text-center text-sm text-[var(--foreground-muted)]">
            {t(
              "auth.signup_disabled_message",
              "Les nouvelles inscriptions ne sont actuellement pas autorisées."
            )}
          </p>
          <div className="mt-6">
            <Link
